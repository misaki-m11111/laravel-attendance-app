        ...
        <form method="POST" action="{{ route('admin.attendance.update', $attendance->id) }}">
            ...
            <div class="attendance-detail__card">
                    ...
                    <div class="attendance-detail__value">
                        <div class="attendance-detail__time">
                            <input type="text" name="clock_in"
                                ...
                                class="attendance-detail__input" {{ $hasPendingRequest ? 'readonly' : '' }}>
                ...
                <div class="attendance-detail__row attendance-detail__row--textarea">
                    ...
                    <div class="attendance-detail__value">
                        <textarea name="remarks" class="attendance-detail__textarea" {{ $hasPendingRequest ? 'readonly' : '' }}>{{ old('remarks', $attendance->remarks) }}</textarea>
